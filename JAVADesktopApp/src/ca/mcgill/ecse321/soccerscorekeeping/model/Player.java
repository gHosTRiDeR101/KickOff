...
public class Player
{
  ...
  //Returns the total number of goals scored by a player
  ...
  //Returns the total number of yellow cards received by the player
  ...
  //Returns the total number of red cards received by the player
  public int redCards()
  {
	  int i = yellowCards();
  ...
  //Returns the total number of penalty kicks conceived by the player
